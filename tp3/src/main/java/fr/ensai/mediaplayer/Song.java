...
public class Song extends Media{
    ...
    /**
     * Constructs a new Song object from media
     *
     ...
     * @param genres   List of musical genres.
     */
    public Song(String title, Artist singer, int year, int duration, String lyrics, Artist author, Artist composer, List<MusicalGenre> genres) {
